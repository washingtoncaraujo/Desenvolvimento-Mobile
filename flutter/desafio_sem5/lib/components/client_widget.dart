...
return ListTile(
  ...
  IconButton( onPressed: () {
     Navigator.of(context).pushNamed(Routes.FORMULARIO_cliente, arguments: cliente); },
  ...
  showDialog( context: context,
    ...
    actions: <Widget>[
    FloatingActionButton( onPressed: () => Navigator.of(context).pop(false), child: const Text('Não'),
  ),
FloatingActionButton( onPressed: () => Navigator.of(context).pop(true), child: const Text('Sim'),
)],),
).then((confimed) => {
if (confimed) {
